...
const features = [
  {
    ...
    description:
      "Stay focused with a clean, clutter-free editor designed to help you capture your thoughts effortlessly.",
  },
  {
    icon: Sparkles,
    title: "Mood-Aware Journaling",
    description:
      "Tag entries with emotions and patterns to better understand your mental well-being over time.",
  },
  {
    icon: Lock,
    title: "End-to-End Privacy",
    description:
      "Your journal stays yours — encrypted entries and local-first storage to ensure your data is always protected.",
  },
];
  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        One thought at a time. <br />  One day at a time.
        </h1>
        <p className="text-lg md:text-xl text-orange-800 mb-8 italic">
        Document your journey and rediscover yourself.
        </p>
      ...
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            Capture your thoughts, calm your mind, and connect with yourself through daily journaling.
            </p>
